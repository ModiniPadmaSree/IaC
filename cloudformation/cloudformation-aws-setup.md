...
After CloudFormation has created the stack and launched the Amazon EC2 instances, in the CloudFormation console, CREATE_COMPLETE will be displayed in the Status column. This process can take several minutes.  
